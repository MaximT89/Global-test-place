...
class MainActivity : AppCompatActivity() {
    ...
    private fun applyBlur() {
        binding.imgTest.viewTreeObserver.addOnPreDrawListener(object : ViewTreeObserver.OnPreDrawListener {
            override fun onPreDraw(): Boolean {
                binding.imgTest.viewTreeObserver.removeOnPreDrawListener(this)
                binding.imgTest.buildDrawingCache()
                val bmp: Bitmap = binding.imgTest.drawingCache
                blur(bmp, binding.viewTest)
                return true
            }
        })
    }
