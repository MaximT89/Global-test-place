...
class MainActivity : BaseActivity<ActivityMainBinding>() {
    ...
    override fun initObservers() {
        viewModel.state.onEach {
            when(it){
                is MainActivityState.Error -> Snackbar.make(this, binding.root, it.error, Snackbar.LENGTH_LONG).show()
                is MainActivityState.Init -> Snackbar.make(this, binding.root, "Стартанули", Snackbar.LENGTH_LONG).show()
